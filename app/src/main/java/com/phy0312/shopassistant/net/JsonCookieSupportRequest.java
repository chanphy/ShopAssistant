...
public class JsonCookieSupportRequest extends JsonObjectRequest {
    ...
    public Map<String, String> getHeaders() throws AuthFailureError {
        ...
        try {
            ...
            headers.put("IMEI", AndroidUtil.getIMEI(MainApplication.appContext));
            headers.put("IMSI", AndroidUtil.getIMSI(MainApplication.appContext));
            headers.put("AppVerCode", AndroidUtil.getVersionCode(MainApplication.appContext) + "");
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
